...
insert into CP_PARAM (PRODUCT_CODE, PARAM_CNNAME, PARAM_ENNAME, PARAM_VALUE, READ_FLAG, DESCRIPTION)
values ('EP', '他行卡调用B2C转账回调页面', 'B2C_TRANSFER_RESULT_NOTIFY_URL', 'http://10.233.94.78:9080/ibank-web/payment/transfer/receiveB2CResult', '1', '他行卡调用B2C转账回调页面');
insert into CP_PARAM (PRODUCT_CODE, PARAM_CNNAME, PARAM_ENNAME, PARAM_VALUE, READ_FLAG, DESCRIPTION)
...
insert into CP_PARAM (PRODUCT_CODE, PARAM_CNNAME, PARAM_ENNAME, PARAM_VALUE, READ_FLAG, DESCRIPTION)
values ('EP', '充值订单支付结果地址', 'RECHARGE_RESULT_NOTIFY_URL', 'http://10.233.94.78:9080/ibank-web/payment/recharge/rechargeByExternalAcctResult', '1', '充值订单支付结果地址');
insert into CP_PARAM (PRODUCT_CODE, PARAM_CNNAME, PARAM_ENNAME, PARAM_VALUE, READ_FLAG, DESCRIPTION)
...
insert into CP_PARAM (PRODUCT_CODE, PARAM_CNNAME, PARAM_ENNAME, PARAM_VALUE, READ_FLAG, DESCRIPTION)
values ('EP', '电子商务回调页面', 'RESULT_NOTIFY_URL', 'http://10.233.94.78:9080/ibank-web/payment/consume/MerchantResult', '1', '电子商务回调地址');
insert into CP_PARAM (PRODUCT_CODE, PARAM_CNNAME, PARAM_ENNAME, PARAM_VALUE, READ_FLAG, DESCRIPTION)
