...
insert into CP_PARAM (PRODUCT_CODE, PARAM_CNNAME, PARAM_ENNAME, PARAM_VALUE, READ_FLAG, DESCRIPTION)
values ('EP', '他行卡调用B2C转账回调页面', 'B2C_TRANSFER_RESULT_NOTIFY_URL', 'http://xxxxxxxxxxxxxxxxx/ibank-web/payment/transfer/receiveB2CResult', '1', '他行卡调用B2C转账回调页面');
insert into CP_PARAM (PRODUCT_CODE, PARAM_CNNAME, PARAM_ENNAME, PARAM_VALUE, READ_FLAG, DESCRIPTION)
...
insert into CP_PARAM (PRODUCT_CODE, PARAM_CNNAME, PARAM_ENNAME, PARAM_VALUE, READ_FLAG, DESCRIPTION)
values ('EP', '充值订单支付结果地址', 'RECHARGE_RESULT_NOTIFY_URL', 'http://xxxxxxxxxxxxxxxx/ibank-web/payment/recharge/rechargeByExternalAcctResult', '1', '充值订单支付结果地址');
insert into CP_PARAM (PRODUCT_CODE, PARAM_CNNAME, PARAM_ENNAME, PARAM_VALUE, READ_FLAG, DESCRIPTION)
...
insert into CP_PARAM (PRODUCT_CODE, PARAM_CNNAME, PARAM_ENNAME, PARAM_VALUE, READ_FLAG, DESCRIPTION)
values ('EP', '电子商务回调页面', 'RESULT_NOTIFY_URL', 'http://xxxxxxxxxxxxxxxx/ibank-web/payment/consume/MerchantResult', '1', '电子商务回调地址');
insert into CP_PARAM (PRODUCT_CODE, PARAM_CNNAME, PARAM_ENNAME, PARAM_VALUE, READ_FLAG, DESCRIPTION)
...
insert into CP_PARAM (PRODUCT_CODE, PARAM_CNNAME, PARAM_ENNAME, PARAM_VALUE, READ_FLAG, DESCRIPTION)
values ('EP', '签名验签服务器证书', 'NETSIGN_CERTDN', 'O=ABC,OU=PaymentGateway,CN=MainServer.0001', '1', '测试环境签名验签服务器证书，生产环境进行修改');
insert into CP_PARAM (PRODUCT_CODE, PARAM_CNNAME, PARAM_ENNAME, PARAM_VALUE, READ_FLAG, DESCRIPTION)
...
insert into CP_PARAM (PRODUCT_CODE, PARAM_CNNAME, PARAM_ENNAME, PARAM_VALUE, READ_FLAG, DESCRIPTION)
values ('EP', 'AI对账的原文件路径', 'AISOUREFILE', '/var/ibanknas/batch/payment/external/abis', '1', 'AI对账的原文件路径');
insert into CP_PARAM (PRODUCT_CODE, PARAM_CNNAME, PARAM_ENNAME, PARAM_VALUE, READ_FLAG, DESCRIPTION)
values ('EP', '人行大小额小额退汇拒绝文件名前缀', 'BEPSIBNKFILENAMEPREFIX', 'BEPSIBNK', '1', '人行大小额小额退汇拒绝文件名前缀');
insert into CP_PARAM (PRODUCT_CODE, PARAM_CNNAME, PARAM_ENNAME, PARAM_VALUE, READ_FLAG, DESCRIPTION)
values ('EP', 'Boeing对账的原文件路径', 'BOEINGSOUREFILE', '/var/ibanknas/batch/payment/external/boeing', '1', 'Boeing对账的原文件路径');
insert into CP_PARAM (PRODUCT_CODE, PARAM_CNNAME, PARAM_ENNAME, PARAM_VALUE, READ_FLAG, DESCRIPTION)
...
insert into CP_PARAM (PRODUCT_CODE, PARAM_CNNAME, PARAM_ENNAME, PARAM_VALUE, READ_FLAG, DESCRIPTION)
values ('EP', '人行大小对账文件路径前缀', 'IBNKINTSPATHPREFIX', '/var/ibanknas/batch/payment/external/ints', '1', '人行大小对账文件路径前缀');
insert into CP_PARAM (PRODUCT_CODE, PARAM_CNNAME, PARAM_ENNAME, PARAM_VALUE, READ_FLAG, DESCRIPTION)
values ('EP', '支付批量导表时间跨度(分钟)', 'PARAM_EXPORT_MIN', '60', '1', '支付批量导表时间跨度(分钟)：导出X分钟的数据');
insert into CP_PARAM (PRODUCT_CODE, PARAM_CNNAME, PARAM_ENNAME, PARAM_VALUE, READ_FLAG, DESCRIPTION)
values ('EP', '对账生成文件的根目录', 'PREFILENAME', '/var/ibanknas/batch/payment/inner', '1', '对账生成文件的根目录');
insert into CP_PARAM (PRODUCT_CODE, PARAM_CNNAME, PARAM_ENNAME, PARAM_VALUE, READ_FLAG, DESCRIPTION)
