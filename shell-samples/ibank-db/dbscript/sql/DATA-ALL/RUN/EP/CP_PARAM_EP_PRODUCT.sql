...
values ('EP', 'A系统资金沉淀账户省市代码', 'DEPOSIT_ACCOUNT_PROVINCE_A', 'xx', '1', 'A系统资金沉淀账户省市代码');
insert into CP_PARAM (PRODUCT_CODE, PARAM_CNNAME, PARAM_ENNAME, PARAM_VALUE, READ_FLAG, DESCRIPTION)
values ('EP', 'B系统存款账户操作码', 'BUSINESS_OPERATION_CODE_B', '01030101', '1', 'B系统存款账户操作码');
insert into CP_PARAM (PRODUCT_CODE, PARAM_CNNAME, PARAM_ENNAME, PARAM_VALUE, READ_FLAG, DESCRIPTION)
values ('EP', 'B系统余额类型码', 'BALANCE_CODE_B', '19110', '1', 'B系统余额类型码');
insert into CP_PARAM (PRODUCT_CODE, PARAM_CNNAME, PARAM_ENNAME, PARAM_VALUE, READ_FLAG, DESCRIPTION)
values ('EP', 'B系统核算操作码', 'ADJUST_ACCOUNTS_OPERATION_CODE', 'R000', '1', 'B系统核算操作码');
insert into CP_PARAM (PRODUCT_CODE, PARAM_CNNAME, PARAM_ENNAME, PARAM_VALUE, READ_FLAG, DESCRIPTION)
...
insert into CP_PARAM (PRODUCT_CODE, PARAM_CNNAME, PARAM_ENNAME, PARAM_VALUE, READ_FLAG, DESCRIPTION)
values ('EP', '他行卡调用B2C转账回调页面', 'B2C_TRANSFER_RESULT_NOTIFY_URL', 'http://www.openaboc.com/payment/transfer/receiveB2CResult', '1', '他行卡调用B2C转账回调页面');
insert into CP_PARAM (PRODUCT_CODE, PARAM_CNNAME, PARAM_ENNAME, PARAM_VALUE, READ_FLAG, DESCRIPTION)
...
insert into CP_PARAM (PRODUCT_CODE, PARAM_CNNAME, PARAM_ENNAME, PARAM_VALUE, READ_FLAG, DESCRIPTION)
values ('EP', '充值订单支付结果地址', 'RECHARGE_RESULT_NOTIFY_URL', 'http://www.openaboc.com/payment/recharge/rechargeByExternalAcctResult', '1', '充值订单支付结果地址');
insert into CP_PARAM (PRODUCT_CODE, PARAM_CNNAME, PARAM_ENNAME, PARAM_VALUE, READ_FLAG, DESCRIPTION)
...
insert into CP_PARAM (PRODUCT_CODE, PARAM_CNNAME, PARAM_ENNAME, PARAM_VALUE, READ_FLAG, DESCRIPTION)
values ('EP', '电子商务回调页面', 'RESULT_NOTIFY_URL', 'http://www.openaboc.com/payment/consume/MerchantResult', '1', '电子商务回调地址');
insert into CP_PARAM (PRODUCT_CODE, PARAM_CNNAME, PARAM_ENNAME, PARAM_VALUE, READ_FLAG, DESCRIPTION)
...
insert into CP_PARAM (PRODUCT_CODE, PARAM_CNNAME, PARAM_ENNAME, PARAM_VALUE, READ_FLAG, DESCRIPTION)
values ('EP', '签名验签服务器地址', 'NETSIGN_IP', '10.235.103.218', '1', '签名验签服务器地址');
insert into CP_PARAM (PRODUCT_CODE, PARAM_CNNAME, PARAM_ENNAME, PARAM_VALUE, READ_FLAG, DESCRIPTION)
values ('EP', '签名验签服务器端口', 'NETSIGN_PORT', '5000', '1', '签名验签服务器端口');
insert into CP_PARAM (PRODUCT_CODE, PARAM_CNNAME, PARAM_ENNAME, PARAM_VALUE, READ_FLAG, DESCRIPTION)
values ('EP', '签名验签服务器证书', 'NETSIGN_CERTDN', 'O=ABC,OU=PaymentGateway,CN=MainServer.0001', '1', '签名验签服务器证书');
insert into CP_PARAM (PRODUCT_CODE, PARAM_CNNAME, PARAM_ENNAME, PARAM_VALUE, READ_FLAG, DESCRIPTION)
values ('EP', '银行卡密码输入错误提示信息', 'BANKCARD_PASSWORD_ERROR', '您的银行密码输入有误，请确认！', '1', '银行卡密码输入错误提示信息');
insert into CP_PARAM (PRODUCT_CODE, PARAM_CNNAME, PARAM_ENNAME, PARAM_VALUE, READ_FLAG, DESCRIPTION)
values ('EP', '银行卡处于锁定状态提示信息', 'BANKCARD_LOCKED', '密码已被锁定，请到柜台解锁！', '1', '银行卡处于锁定状态提示信息');
insert into CP_PARAM (PRODUCT_CODE, PARAM_CNNAME, PARAM_ENNAME, PARAM_VALUE, READ_FLAG, DESCRIPTION)
...
insert into CP_PARAM (PRODUCT_CODE, PARAM_CNNAME, PARAM_ENNAME, PARAM_VALUE, READ_FLAG, DESCRIPTION)
values ('EP', 'AI对账的原文件路径', 'AISOUREFILE', '/appl/batch/payment/external/abis', '1', 'AI对账的原文件路径');
insert into CP_PARAM (PRODUCT_CODE, PARAM_CNNAME, PARAM_ENNAME, PARAM_VALUE, READ_FLAG, DESCRIPTION)
values ('EP', '人行大小额小额退汇拒绝文件名前缀', 'BEPSIBNKFILENAMEPREFIX', 'BEPSIBNK', '1', '人行大小额小额退汇拒绝文件名前缀');
insert into CP_PARAM (PRODUCT_CODE, PARAM_CNNAME, PARAM_ENNAME, PARAM_VALUE, READ_FLAG, DESCRIPTION)
values ('EP', 'Boeing对账的原文件路径', 'BOEINGSOUREFILE', '/appl/batch/payment/external/boeing', '1', 'Boeing对账的原文件路径');
insert into CP_PARAM (PRODUCT_CODE, PARAM_CNNAME, PARAM_ENNAME, PARAM_VALUE, READ_FLAG, DESCRIPTION)
...
insert into CP_PARAM (PRODUCT_CODE, PARAM_CNNAME, PARAM_ENNAME, PARAM_VALUE, READ_FLAG, DESCRIPTION)
values ('EP', '人行大小对账文件路径前缀', 'IBNKINTSPATHPREFIX', '/appl/batch/payment/external/ints', '1', '人行大小对账文件路径前缀');
insert into CP_PARAM (PRODUCT_CODE, PARAM_CNNAME, PARAM_ENNAME, PARAM_VALUE, READ_FLAG, DESCRIPTION)
values ('EP', '支付批量导表时间跨度(分钟)', 'PARAM_EXPORT_MIN', '60', '1', '支付批量导表时间跨度(分钟)：导出X分钟的数据');
insert into CP_PARAM (PRODUCT_CODE, PARAM_CNNAME, PARAM_ENNAME, PARAM_VALUE, READ_FLAG, DESCRIPTION)
values ('EP', '对账生成文件的根目录', 'PREFILENAME', '/appl/batch/payment/inner', '1', '对账生成文件的根目录');
insert into cp_param (PRODUCT_CODE, PARAM_CNNAME, PARAM_ENNAME, PARAM_VALUE, READ_FLAG, DESCRIPTION)
...
insert into cp_param (PRODUCT_CODE, PARAM_CNNAME, PARAM_ENNAME, PARAM_VALUE, READ_FLAG, DESCRIPTION)
values ('EP', 'AI的Shell脚本路径', 'AISHELL', '/appl/batch/payment/shell/aintdirectory.sh', '1', 'AI的Shell脚本路径');
insert into cp_param (PRODUCT_CODE, PARAM_CNNAME, PARAM_ENNAME, PARAM_VALUE, READ_FLAG, DESCRIPTION)
values ('EP', 'BOEING的Shell脚本路径', 'BOEINGSHELL', '/appl/batch/payment/shell/boeingdirectory.sh', '1', 'BOEING的Shell脚本路径');
insert into cp_param (PRODUCT_CODE, PARAM_CNNAME, PARAM_ENNAME, PARAM_VALUE, READ_FLAG, DESCRIPTION)
values ('EP', 'INTS的Shell脚本路径', 'INTSSHELL', '/appl/batch/payment/shell/intsdirectory.sh', '1', 'INTS的Shell脚本路径');
commit;
