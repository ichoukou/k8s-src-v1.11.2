...
DECLARE
     ...
     my_sqltext   CLOB;
    BEGIN
      my_sqltext :=' SELECT count(' || ' chr(42)||') totalCount from ibanktest.EP_ORDER_TRACE WHERE (USER_NO = ''18E09JUIQ02R5BB7E50A0000654AF2D3'' or EXT_ACCT_NO = ''CA05E0010000135698'')  AND TRANS_TYPE IN (2001,3003,3003, 3002,6005, 2002,4001, 3005, 3001, 4001,2002,2032, 4001, 4001, 4001,4001, 4001,4001,4001,4001,4001,4001)'
